...
package com.front.zoom.spinnerwheellibrary.spinnerwheel;
...
import com.front.zoom.spinnerwheellibrary.R;
...
public class WheelVerticalView extends AbstractWheelView {
    ...
    protected void createItemsLayout() {
        if (mItemsLayout == null) {
            ...
            mItemsLayout.setGravity(Gravity.CENTER_HORIZONTAL);
        }
    }
    ...
    protected void measureLayout() {
        mItemsLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
